  ...
  const copy = pending.kind === "attachEnergy"
    ...
    : pending.kind === "retreatTarget"
      ...
      : pending.kind === "discardForScout"
        ...
        : pending.kind === "resetWhistleHandChoice"
          ? "Choose 1 Umamusume in your hand to switch with a random Umamusume from your deck."
          : pending.kind === "masterCleatHammerTarget"
            ? "Choose a target: click an attached Tool pip, or click the Stadium card."
